...
#SBATCH --job-name=str_models1            # Name of the job
...
#SBATCH --output=str_models1_%j.out
#SBATCH --error=str_models1_%j.err
...
python ../05_Cell_Painting_models/Cell_Painting_models_v2.py
