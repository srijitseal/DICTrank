...
#SBATCH --job-name=str_models2            # Name of the job
...
#SBATCH --output=str_models2_%j.out
#SBATCH --error=str_models2_%j.err
...
python ../03_Structural_models/Structural_models.py
python ../08_CellScape_models/CellScape_models.py