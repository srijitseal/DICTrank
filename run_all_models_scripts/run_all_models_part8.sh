...
#SBATCH --job-name=str_models8            # Name of the job
...
#SBATCH --output=str_models8_%j.out
#SBATCH --error=str_models8_%j.err
...
python ../04_Physicochemical_models/Physicochemical_models.py
