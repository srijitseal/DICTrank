...
#SBATCH --job-name=str_models6           # Name of the job
...
#SBATCH --output=str_models6_%j.out
#SBATCH --error=str_models6_%j.err
...
python ../09b_MOA_Cmax/MOA_Cmax_total_models.py
python ../09b_MOA_Cmax/MOA_Cmax_unbound_models.py
