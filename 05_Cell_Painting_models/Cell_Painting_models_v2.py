...
for dataset in os.listdir(data_path):
    ...
    for activity in tqdm(activity_names, desc="Processing activities"):
        ...
        pd.DataFrame(results).T.to_csv('./cellpainting_model_results.csv')
...
results_df.to_csv('./cellpainting_model_results.csv', index=False)

# Concatenate and save held-out test set results
pd.concat(held_out_results).to_csv('./cellpainting_model_held_out_test_results.csv', index=False)
